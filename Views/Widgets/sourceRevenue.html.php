    ...
    <div class="pt-sd pr-md pb-md pl-md">
        <div id="campaign-source-revenue-table" style="height:<?php echo $data['height']; ?>px">
            ...
            <div class="responsive-table">
                <div id="source-builder-overlay"><div style="position: relative; top: <?php echo $data['height'] / 3; ?>px; left: 45%; index: 1024;display:inline-block;"><i class="fa fa-spinner fa-spin fa-5x"></i></div></div>
